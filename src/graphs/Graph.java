...
public class Graph implements contracts.Graph {
  ...
  public Graph(int knotenanzahl) {
    ...
    for (int i = 0; i < knotenanzahl; i++) adj[i] = new boolean[knotenanzahl];
  }

  public void setzeKante(int von, int nach) {
    if (von >= 0 && nach >= 0 && von < knotenanzahl && nach < knotenanzahl) adj[von][nach] = true;
  }

  public void loescheKante(int von, int nach) {
    if (von >= 0 && nach >= 0 && von < knotenanzahl && nach < knotenanzahl) adj[von][nach] = false;
  }
